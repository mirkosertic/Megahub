...
class FilesHTMLElement extends HTMLElement {
    ...
    deleteProject(projectName) {
        ...
        this.dispatchEvent(
            new CustomEvent(APP_EVENT_PROJECT_DELETE, {
                bubbles: true,
                composed: true,
    ...
    openProject(projectName) {
        // Dispatch CustomEvent instead of calling window.Application directly
        this.dispatchEvent(
            new CustomEvent(APP_EVENT_PROJECT_OPEN, {
                bubbles: true,
                composed: true,
                detail: { id: projectName },
            })
    ...
    createProject(projectName) {
        // Dispatch CustomEvent instead of calling window.Application directly
        this.dispatchEvent(
            new CustomEvent(APP_EVENT_PROJECT_CREATE, {
                bubbles: true,
                composed: true,
                detail: { id: projectName },
            })
    ...
    _setAutoStartProjectAndNotify(project) {
        ...
        if (project) {
            // Dispatch CustomEvent instead of calling window.Application directly
            this.dispatchEvent(
                new CustomEvent(APP_EVENT_AUTOSTART_SET, {
                    bubbles: true,
                    composed: true,
                    detail: { project },
                })
